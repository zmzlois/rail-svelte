...
export interface MutationGenqlSelection {
	...
	/** Updates a template. */
	templateUpdate?: TemplateGenqlSelection & {
		__args: { id: Scalars['String']; input: TemplateUpdateInput };
	};
	/** Setup 2FA authorization for authenticated user. */
...
export interface QueryGenqlSelection {
	...
	/** Fetch Discord info associated with Direct Support-eligible team members, given a Discord UID */
	teamDirectSupportDiscordInfoForDiscordId?: TeamDirectSupportDiscordInfoGenqlSelection & {
		__args: { discordId: Scalars['String'] };
	};
	/** Get all templates for a team. */
...
export interface ServiceCreateInput {
	...
	variables?: Scalars['ServiceVariables'] | null;
}
...
export interface TemplateServiceCreateInput {
	config: Scalars['TemplateServiceConfig'];
}
...
export interface TemplateServiceUpdateInput {
	config: Scalars['TemplateServiceConfig'];
	id?: Scalars['String'] | null;
}
...
export interface TemplateUpdateInput {
	...
	forceUpdate?: Scalars['Boolean'] | null;
	metadata: Scalars['TemplateMetadata'];
...
export const isTeamDirectSupportDiscordInfo = (
	obj?: { __typename?: any } | null
): obj is TeamDirectSupportDiscordInfo => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTeamDirectSupportDiscordInfo"');
...
export const isUserProfileResponsePublicProjectsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUserProfileResponsePublicProjectsConnectionEdge"');
