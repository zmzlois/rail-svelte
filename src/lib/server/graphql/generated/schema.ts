...
export type ActiveFeatureFlag = 'DEPLOYMENTS_UI_V2' | 'STACKER_WORKFLOWS' | 'TEMPLATE_SERVICE_EJECT'
...
export type DeploymentEventStep = 'BUILD_IMAGE' | 'CREATE_CONTAINER' | 'DRAIN_INSTANCES' | 'HEALTHCHECK' | 'PUBLISH_IMAGE' | 'SNAPSHOT_CODE'
...
export type Node = (AdoptionInfo | ApiToken | BanReasonHistory | Container | Credit | Customer | Deployment | DeploymentEvent | DeploymentSnapshot | DeploymentTrigger | Environment | Event | Integration | IntegrationAuth | InviteCode | ObservabilityDashboard | ObservabilityDashboardItem | ObservabilityDashboardItemInstance | PlanLimitOverride | Plugin | Preferences | Project | ProjectPermission | ProjectToken | ProjectWebhook | ProviderAuth | ReferralInfo | RefundRequest | Service | ServiceInstance | Session | Team | TeamPermission | Template | TemplateService | UsageAnomaly | UsageLimit | User | Variable | Volume | VolumeInstance | Withdrawal | WithdrawalAccount) & { __isUnion?: true }
...
export type ProjectUsageProperty = 'CPU_USAGE' | 'CURRENT_USAGE' | 'DISK_USAGE' | 'ESTIMATED_USAGE' | 'MEMORY_USAGE' | 'NETWORK_USAGE'
...
export interface TemplateCreateInput {canvasConfig?: (Scalars['CanvasConfig'] | null),config: Scalars['TemplateConfig'],demoProjectId?: (Scalars['String'] | null),metadata: Scalars['TemplateMetadata'],services: TemplateServiceCreateInput[],teamId?: (Scalars['String'] | null)}
...
export interface TemplateUpdateInput {canvasConfig?: (Scalars['CanvasConfig'] | null),config: Scalars['TemplateConfig'],demoProjectId?: (Scalars['String'] | null),
...
export const enumActiveFeatureFlag = {
   DEPLOYMENTS_UI_V2: 'DEPLOYMENTS_UI_V2' as const,
