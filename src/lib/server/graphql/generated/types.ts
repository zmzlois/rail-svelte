export default {
	scalars: [
		1, 9, 11, 12, 13, 14, 16, 18, 22, 31, 32, 33, 35, 39, 41, 43, 48, 74, 79, 86, 88, 89, 97, 99,
		105, 107, 108, 121, 133, 134, 168, 177, 227, 230, 232, 237, 238, 240, 258, 260, 263, 267, 268,
		269, 284, 291, 300, 303, 309, 311, 316, 318, 319, 325, 352, 360, 361, 363
	],
	types: {
		AccessRule: {
			disallowed: [263],
		...
		CreditTransferMetrics: {
			creditTransferAvg: [79],
			creditTransferCount: [89],
			creditTransferSum: [89],
			__typename: [263]
		},
		CreditType: {},
		CustomDomain: {
		...
		Customer: {
			...
			defaultPaymentMethod: [124],
			defaultPaymentMethodId: [263],
			id: [86],
			invoices: [29],
			isPrepaying: [11],
			isTrialing: [11],
			isUsageSubscriber: [11],
			isWithdrawingToCredits: [11],
			planLimitOverride: [126],
			remainingUsageCreditBalance: [79],
			state: [269],
			stripeCustomerId: [263],
			subscriptions: [30],
			teamId: [263],
			usageLimit: [320],
			userId: [263],
		...
		CustomerSubscription: {
			...
			cancelAt: [263],
			cancelAtPeriodEnd: [11],
			couponId: [263],
			discounts: [265],
			id: [263],
			items: [266],
			latestInvoiceId: [263],
			nextInvoiceCurrentTotal: [89],
			nextInvoiceDate: [263],
			status: [263],
			__typename: [263]
		},
		...
		Environment: {
			...
			sourceEnvironment: [55],
			unmergedChangesCount: [89],
			updatedAt: [35],
			variables: [
				66,
				{
		...
		EnvironmentCreateInput: {
			...
			name: [263],
			projectId: [263],
			skipInitialDeploys: [11],
			sourceEnvironmentId: [263],
			stageInitialChanges: [11],
			__typename: [263]
		},
		...
		Mutation: {
			...
			baseEnvironmentOverride: [
				...
				{
					id: [263, 'String!'],
					input: [8, 'BaseEnvironmentOverrideInput!']
				}
			],
			customDomainCreate: [
				23,
			...
			customerTogglePayoutsToCredits: [
				11,
				{
					customerId: [263, 'String!'],
					input: [364, 'customerTogglePayoutsToCreditsInput!']
				}
			],
			deploymentCancel: [
				11,
			...
			deploymentTriggerCreate: [
				45,
				{
					input: [46, 'DeploymentTriggerCreateInput!']
				}
			],
			...
			deploymentTriggerUpdate: [
				...
				{
					id: [263, 'String!'],
					input: [47, 'DeploymentTriggerUpdateInput!']
				}
			],
			egressGatewayAssociationCreate: [
				52,
				{
					input: [53, 'EgressGatewayCreateInput!']
				}
			],
			egressGatewayAssociationsClear: [
				11,
				{
					input: [54, 'EgressGatewayServiceTargetInput!']
				}
			],
			emailChangeConfirm: [
				11,
			...
			environmentCreate: [
				55,
				{
					input: [56, 'EnvironmentCreateInput!']
				}
			],
			environmentDelete: [
				11,
			...
			environmentRename: [
				...
				{
					id: [263, 'String!'],
					input: [62, 'EnvironmentRenameInput!']
				}
			],
			environmentTriggersDeploy: [
				11,
				{
					input: [65, 'EnvironmentTriggersDeployInput!']
				}
			],
			eventBatchTrack: [
				11,
				{
					input: [72, 'EventBatchTrackInput!']
				}
			],
			eventTrack: [
				11,
				{
					input: [76, 'EventTrackInput!']
				}
			],
			fairUseAgree: [
				11,
			...
			featureFlagAdd: [
				11,
				{
					input: [78, 'FeatureFlagToggleInput!']
				}
			],
			featureFlagRemove: [
				11,
			...
			githubRepoDeploy: [
				11,
				{
					input: [82, 'GitHubRepoDeployInput!']
				}
			],
			githubRepoUpdate: [
				11,
				{
					input: [83, 'GitHubRepoUpdateInput!']
				}
			],
			herokuImportVariables: [
				89,
				{
					input: [85, 'HerokuImportVariablesInput!']
				}
			],
			integrationCreate: [
				90,
				{
					input: [94, 'IntegrationCreateInput!']
				}
			],
			integrationDelete: [
				11,
			...
			integrationUpdate: [
				...
				{
					id: [263, 'String!'],
					input: [95, 'IntegrationUpdateInput!']
				}
			],
			inviteCodeUse: [
				144,
			...
			jobApplicationCreate: [
				11,
				{
					input: [98, 'JobApplicationCreateInput!'],
					resume: [316, 'Upload!']
				}
			],
			loginSessionAuth: [
				11,
				{
					input: [103, 'LoginSessionAuthInput!']
				}
			],
			loginSessionCancel: [
				11,
			...
			missingCommandAlert: [
				11,
				{
					input: [111, 'MissingCommandAlertInput!']
				}
			],
			observabilityDashboardCreate: [
				11,
				{
					input: [115, 'ObservabilityDashboardCreateInput!']
				}
			],
			...
			observabilityDashboardUpdate: [
				...
				{
					id: [263, 'String!'],
					input: [122, '[ObservabilityDashboardUpdateInput!]!']
				}
			],
			pluginCreate: [
				128,
				{
					input: [131, 'PluginCreateInput!']
				}
			],
			pluginDelete: [
				11,
			...
			pluginResetCredentials: [
				...
				{
					id: [263, 'String!'],
					input: [234, 'ResetPluginCredentialsInput!']
				}
			],
			pluginRestart: [
				128,
			...
			pluginUpdate: [
				...
				{
					id: [263, 'String!'],
					input: [135, 'PluginUpdateInput!']
				}
			],
			preferencesUpdate: [
				138,
				{
					input: [139, 'PreferencesUpdateData!']
				}
			],
			privateNetworkCreateOrGet: [
				140,
				{
					input: [141, 'PrivateNetworkCreateOrGetInput!']
				}
			],
			privateNetworkEndpointCreateOrGet: [
				142,
				{
					input: [143, 'PrivateNetworkEndpointCreateOrGetInput!']
				}
			],
			...
			privateNetworkEndpointRename: [
				11,
				{
					dnsName: [263, 'String!'],
					id: [263, 'String!'],
					privateNetworkId: [263, 'String!']
				}
			],
			privateNetworksForEnvironmentDelete: [
				11,
				{
					environmentId: [263, 'String!']
				}
			],
			projectClaim: [
				144,
			...
			projectInviteUser: [
				...
				{
					id: [263, 'String!'],
					input: [157, 'ProjectInviteUserInput!']
				}
			],
			projectLeave: [
				11,
			...
			projectMemberRemove: [
				159,
				{
					input: [160, 'ProjectMemberRemoveInput!']
				}
			],
			projectMemberUpdate: [
				159,
				{
					input: [161, 'ProjectMemberUpdateInput!']
				}
			],
			projectTokenCreate: [
				263,
				{
					input: [172, 'ProjectTokenCreateInput!']
				}
			],
			projectTokenDelete: [
				11,
			...
			projectTransferConfirm: [
				11,
				{
					input: [173, 'ProjectTransferConfirmInput!']
				}
			],
			projectTransferInitiate: [
				11,
				{
					input: [174, 'ProjectTransferInitiateInput!']
				}
			],
			projectTransferToTeam: [
				...
				{
					id: [263, 'String!'],
					input: [175, 'ProjectTransferToTeamInput!']
				}
			],
			...
			recoveryCodeGenerate: [223],
			recoveryCodeValidate: [
				11,
				{
					input: [222, 'RecoveryCodeValidateInput!']
				}
			],
			referralInfoUpdate: [
				224,
				{
					input: [225, 'ReferralInfoUpdateInput!']
				}
			],
			sendCommunityThreadNotificationEmail: [
				11,
				{
					input: [239, 'SendCommunityThreadNotificationEmailInput!']
				}
			],
			serviceConnect: [
				241,
				{
					id: [263, 'String!'],
					input: [242, 'ServiceConnectInput!']
				}
			],
			serviceCreate: [
				241,
				{
					input: [243, 'ServiceCreateInput!']
				}
			],
			serviceDelete: [
				11,
			...
			serviceDomainCreate: [
				246,
				{
					input: [247, 'ServiceDomainCreateInput!']
				}
			],
			serviceDomainDelete: [
				11,
			...
			serviceDomainUpdate: [
				11,
				{
					input: [248, 'ServiceDomainUpdateInput!']
				}
			],
			...
			serviceInstanceUpdate: [
				...
				{
					environmentId: [263],
					input: [250, 'ServiceInstanceUpdateInput!'],
					serviceId: [263, 'String!']
				}
			],
			...
			sharedVariableConfigure: [
				341,
				{
					input: [261, 'SharedVariableConfigureInput!']
				}
			],
			tcpProxyCreate: [
				270,
				{
					input: [271, 'TCPProxyCreateInput!']
				}
			],
			tcpProxyDelete: [
				11,
			...
			teamBulkProjectTransfer: [
				11,
				{
					input: [273, 'TeamBulkProjectTransferInput!']
				}
			],
			teamCreate: [
				272,
				{
					input: [276, 'TeamCreateInput!']
				}
			],
			teamCreateAndSubscribe: [
				275,
				{
					input: [274, 'TeamCreateAndSubscribeInput!']
				}
			],
			teamDelete: [
				11,
			...
			teamInviteCodeCreate: [
				...
				{
					id: [263, 'String!'],
					input: [278, 'TeamInviteCodeCreateInput!']
				}
			],
			teamInviteCodeUse: [
				272,
			...
			teamPermissionChange: [
				11,
				{
					input: [281, 'TeamPermissionChangeInput!']
				}
			],
			teamUpdate: [
				272,
			...
			teamUserRemove: [
				...
				{
					id: [263, 'String!'],
					input: [287, 'TeamUserRemoveInput!']
				}
			],
			telemetrySend: [
				11,
				{
					input: [288, 'TelemetrySendInput!']
				}
			],
			templateClone: [
				289,
				{
					input: [290, 'TemplateCloneInput!']
				}
			],
			templateCreate: [
				289,
				{
					input: [292, 'TemplateCreateInput!']
				}
			],
			templateDelete: [
				11,
				{
					id: [263, 'String!'],
					input: [294, 'TemplateDeleteInput!']
				}
			],
			templateDeploy: [
				296,
				{
					input: [295, 'TemplateDeployInput!']
				}
			],
			templateGenerate: [
				289,
				{
					input: [298, 'TemplateGenerateInput!']
				}
			],
			templateMaybeUnsetCommunityThreadSlug: [
				11,
				{
					communityThreadSlug: [263, 'String!']
				}
			],
			templatePublish: [
				289,
				{
					id: [263, 'String!'],
					input: [301, 'TemplatePublishInput!']
				}
			],
			templateServiceSourceEject: [
				11,
				{
					input: [305, 'TemplateServiceSourceEjectInput!']
				}
			],
			templateUnpublish: [
				11,
			...
			templateUpdate: [
				...
				{
					id: [263, 'String!'],
					input: [310, 'TemplateUpdateInput!']
				}
			],
			twoFactorInfoCreate: [
				223,
				{
					input: [313, 'TwoFactorInfoCreateInput!']
				}
			],
			twoFactorInfoDelete: [11],
			twoFactorInfoSecret: [314],
			twoFactorInfoValidate: [
				11,
				{
					input: [315, 'TwoFactorInfoValidateInput!']
				}
			],
			...
			usageLimitRemove: [
				11,
				{
					input: [321, 'UsageLimitRemoveInput!']
				}
			],
			usageLimitSet: [
				11,
				{
					input: [322, 'UsageLimitSetInput!']
				}
			],
			userBetaLeave: [11],
			userDelete: [11],
			userDiscordDisconnect: [11],
			userFlagsRemove: [
				11,
				{
					input: [326, 'UserFlagsRemoveInput!']
				}
			],
			userFlagsSet: [
				11,
				{
					input: [327, 'UserFlagsSetInput!']
				}
			],
			userProfileUpdate: [
				11,
				{
					input: [333, 'UserProfileUpdateInput!']
				}
			],
			userTermsUpdate: [323],
			userUpdate: [
				323,
				{
					input: [340, 'UserUpdateInput!']
				}
			],
			variableCollectionUpsert: [
				11,
				{
					input: [342, 'VariableCollectionUpsertInput!']
				}
			],
			variableDelete: [
				11,
				{
					input: [343, 'VariableDeleteInput!']
				}
			],
			variableUpsert: [
				11,
				{
					input: [344, 'VariableUpsertInput!']
				}
			],
			volumeCreate: [
				348,
				{
					input: [349, 'VolumeCreateInput!']
				}
			],
			volumeDelete: [
				11,
			...
			volumeInstanceUpdate: [
				...
				{
					environmentId: [263],
					input: [351, 'VolumeInstanceUpdateInput!'],
					volumeId: [263, 'String!']
				}
			],
			volumeUpdate: [
		...
		Node: {
			...
			on_AdoptionInfo: [2],
			on_ApiToken: [5],
			on_BanReasonHistory: [7],
			on_Container: [19],
			on_Credit: [20],
			on_Customer: [26],
			on_Deployment: [36],
			on_DeploymentEvent: [37],
			on_DeploymentSnapshot: [42],
			on_DeploymentTrigger: [45],
			on_Environment: [55],
			on_Event: [71],
			on_Integration: [90],
			on_IntegrationAuth: [91],
			on_InviteCode: [96],
			on_ObservabilityDashboard: [114],
			on_ObservabilityDashboardItem: [116],
			on_ObservabilityDashboardItemInstance: [120],
			on_PlanLimitOverride: [126],
			on_Plugin: [128],
			on_Preferences: [138],
			on_Project: [144],
			on_ProjectPermission: [162],
			on_ProjectToken: [171],
			on_ProjectWebhook: [180],
			on_ProviderAuth: [183],
			on_ReferralInfo: [224],
			on_RefundRequest: [229],
			on_Service: [241],
			on_ServiceInstance: [249],
			on_Session: [259],
			on_Team: [272],
			on_TeamPermission: [280],
			on_Template: [289],
			on_TemplateService: [302],
			on_UsageAnomaly: [317],
			on_UsageLimit: [320],
			on_User: [323],
			on_Variable: [341],
			on_Volume: [348],
			on_VolumeInstance: [350],
			on_Withdrawal: [358],
			on_WithdrawalAccount: [359],
			__typename: [263]
		},
		...
		Plugin: {
			...
			id: [86],
			logsEnabled: [11],
			migrationDatabaseServiceId: [263],
			name: [134],
			project: [144],
			status: [133],
			variables: [
		...
		Preferences: {
			...
			changelogEmail: [11],
			communityEmail: [11],
			deployCrashedEmail: [11],
			ephemeralEnvironmentEmail: [11],
			id: [86],
			marketingEmail: [11],
			subprocessorUpdatesEmail: [11],
			usageEmail: [11],
			__typename: [263]
		},
		...
		PrivateNetworkEndpoint: {
			...
			privateIps: [263],
			publicId: [263],
			serviceInstanceId: [263],
			tags: [263],
			__typename: [263]
		},
		PrivateNetworkEndpointCreateOrGetInput: {
			environmentId: [263],
			privateNetworkId: [263],
			serviceId: [263],
			serviceName: [263],
			tags: [263],
			__typename: [263]
		...
		Project: {
			...
			subscriptionPlanLimit: [267],
			subscriptionType: [268],
			team: [272],
			teamId: [263],
			updatedAt: [35],
			volumes: [
		...
		PublicProjectInvitation: {
			on_InviteCode: [96],
			on_ProjectInvitation: [155],
			on_Node: [113],
			__typename: [263]
		},
		PublicStats: {
			totalDeploymentsLastMonth: [89],
			totalLogsLastMonth: [9],
			totalProjects: [89],
			totalRequestsLastMonth: [9],
			totalServices: [89],
			totalUsers: [89],
			__typename: [263]
		},
		Query: {
			...
			creditTransferMetrics: [21],
			customDomain: [
				23,
				{
					id: [263, 'String!'],
					projectId: [263, 'String!']
				}
			],
			...
			estimatedUsage: [
				...
				{
					includeDeleted: [11],
					measurements: [107, '[MetricMeasurement!]!'],
					projectId: [263],
					teamId: [263],
					userId: [263]
				}
			...
			githubRepos: [81],
			githubWritableScopes: [263],
			herokuApps: [84],
			integrationAuth: [
				91,
				{
					provider: [263, 'String!'],
					providerId: [263, 'String!']
				}
			],
			integrationAuths: [
				202,
			...
			metrics: [
				110,
				{
					averagingWindowSeconds: [89],
					endDate: [35],
					environmentId: [263],
					groupBy: [108, '[MetricTag!]'],
					includeDeleted: [11],
					measurements: [107, '[MetricMeasurement!]!'],
					pluginId: [263],
					projectId: [263],
					sampleRateSeconds: [89],
					serviceId: [263],
			...
			templateKickbacksLeaderboard: [299],
		...
		ServiceInstance: {
			...
			nixpacksPlan: [97],
			numReplicas: [89],
			railwayConfigFile: [263],
			region: [263],
			restartPolicyMaxRetries: [89],
			restartPolicyType: [238],
			rootDirectory: [263],
			serviceId: [263],
			sleepApplication: [11],
			source: [255],
		...
		SharedVariableConfigureInput: {
			disabledServiceIds: [263],
			enabledServiceIds: [263],
			environmentId: [263],
			name: [263],
			projectId: [263],
			__typename: [263]
